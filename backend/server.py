...
OS_ROLES_DEFAULT = [
    "CEO", "COO", "HR Manager", "Marketing Manager", "Marketing",
    "Operations Manager", "Operations", "Support Manager", "Support",
    "Finance Manager", "Finance", "Tech & Sales", "Designer", "Video Editor",
    "Content Creator", "Social Media Manager", "Warehouse Manager",
    "Employee", "Intern", "Pending",
]
...
PERMISSIONS_CATALOG = {
    ...
    "hr.view": "View HR",
    "hr.manage": "Manage HR (attendance, leaves, payroll, evaluations)",
    "social.view": "View social media",
    "social.manage": "Manage social media posts",
...
_ALL_PERMS = None  # populated below

DEFAULT_ROLE_PERMS = {
    "CEO": list(PERMISSIONS_CATALOG.keys()),
    "COO": list(PERMISSIONS_CATALOG.keys()),
    "HR Manager": ["dashboard.view", "employees.view", "employees.manage", "hr.view", "hr.manage",
                    "applications.view", "applications.manage", "tasks.view", "tasks.manage", "tasks.assign",
                    "notifications.view", "reports.view", "calendar.view", "chat.view", "files.view", "logs.view"],
    "Marketing Manager": ["dashboard.view", "marketing.view", "marketing.manage", "social.view", "social.manage",
                          "customers.view", "analytics.view", "tasks.view", "tasks.manage", "tasks.assign",
                          "calendar.view", "calendar.manage", "chat.view", "files.view", "ai.use", "reports.view"],
    "Marketing": ["dashboard.view", "marketing.view", "social.view", "customers.view", "analytics.view",
                  "tasks.view", "chat.view", "files.view", "calendar.view", "ai.use"],
    "Operations Manager": ["dashboard.view", "orders.view", "orders.manage", "customers.view", "customers.manage",
                            "products.view", "inventory.view", "inventory.manage", "suppliers.view", "suppliers.manage",
                            "tasks.view", "tasks.manage", "tasks.assign", "chat.view", "calendar.view", "reports.view"],
    "Operations": ["dashboard.view", "orders.view", "customers.view", "products.view", "inventory.view",
                    "tasks.view", "chat.view", "calendar.view"],
    "Support Manager": ["dashboard.view", "support.view", "support.manage", "customers.view", "tasks.view",
                        "tasks.manage", "tasks.assign", "chat.view", "calendar.view", "reports.view"],
    "Support": ["dashboard.view", "support.view", "customers.view", "tasks.view", "chat.view", "calendar.view"],
    "Finance Manager": ["dashboard.view", "finance.view", "finance.manage", "hr.view", "reports.view",
                        "analytics.view", "tasks.view", "chat.view", "calendar.view"],
    "Finance": ["dashboard.view", "finance.view", "tasks.view", "chat.view", "calendar.view"],
    "Tech & Sales": ["dashboard.view", "analytics.view", "products.view", "products.manage",
                     "integrations.manage", "settings.view", "tasks.view", "chat.view", "calendar.view"],
    "Designer": ["dashboard.view", "tasks.view", "files.view", "files.manage", "chat.view", "calendar.view", "ai.use"],
    "Video Editor": ["dashboard.view", "tasks.view", "files.view", "files.manage", "chat.view", "calendar.view", "social.view", "ai.use"],
    "Content Creator": ["dashboard.view", "tasks.view", "files.view", "chat.view", "calendar.view", "social.view", "social.manage", "ai.use"],
    "Social Media Manager": ["dashboard.view", "social.view", "social.manage", "marketing.view", "tasks.view", "tasks.manage",
                              "tasks.assign", "chat.view", "calendar.view", "files.view", "ai.use", "analytics.view"],
    "Warehouse Manager": ["dashboard.view", "inventory.view", "inventory.manage", "suppliers.view", "suppliers.manage",
                          "orders.view", "products.view", "tasks.view", "tasks.manage", "chat.view", "calendar.view"],
    "Employee": ["dashboard.view", "tasks.view", "chat.view", "calendar.view", "files.view", "notifications.view"],
    "Intern": ["dashboard.view", "tasks.view", "chat.view", "calendar.view", "notifications.view"],
    "Pending": [],
...
async def os_dashboard_summary(user: dict = Depends(require_perm("dashboard.view"))):
    ...
    newsletter_count = await db.newsletter.count_documents({})
    contacts_count = await db.contacts.count_documents({})
    # Only users with finance.view can see revenue/orders financial metrics
    can_see_finance = "finance.view" in _perms_for(user) or "CEO" == user.get("role")
    return {
        "orders_today": 0 if not can_see_finance else 0,
        "revenue_today": None if not can_see_finance else 0,
        "revenue_visible": can_see_finance,
        "new_customers": 0,
        "pending_orders": 0,
...
# =============================================================================
# UR SETUP OS — Extended features (heartbeat, HR, Social, Chat, Calendar, Files, etc.)
# =============================================================================
try:
    from server_ext import wire as _wire_ext
    _wire_ext(app, db, get_current_user, require_perm, log_activity, hash_password,
              PERMISSIONS_CATALOG, DEFAULT_ROLE_PERMS, OS_ROLES_DEFAULT, _now_iso)
except Exception as _ext_err:
    import logging as _lg
    _lg.exception("Failed to wire server_ext: %s", _ext_err)

# WebSocket chat + Gmail integration
try:
    from server_realtime import wire_realtime as _wire_rt
    _wire_rt(app, db, JWT_SECRET, get_current_user, require_perm, log_activity, _now_iso)
except Exception as _rt_err:
    import logging as _lg
    _lg.exception("Failed to wire server_realtime: %s", _rt_err)